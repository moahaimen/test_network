...
OUT = ROOT/"results/official_sprintlink_pct_emergency"; OUT.mkdir(parents=True, exist_ok=True)
TOPO="sprintlink"; LO,HI=200,400; FP,FD=0.999,0.0510; GNN_MS=27; SW=60
...
def main():
    ...
    print("Sprintlink % EMERGENCY (active~1892). pct x cap x paths_used",flush=True)
    rows=[]
    for pct in [30,35,40,45,50]:
        for cap in [800,1000,1200,1400]:
            for pu in [3,4,5,8]:
